...
const Form = (props: Props) => {
  ...
  return (
    <div className='p-10 text-center bg-[#17171b] rounded-3xl'>
              ...
              <ShadcdnFormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <FormField className='text-black' element={question} key={index} value={field.value} onChange={field.onChange} />
                    </FormControl>
                  </FormItem>
                )}
              />
