  ...
  return (
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent className='sm:max-w-[425px]'>
        <DialogHeader>
          <DialogTitle className='text-black'>Your Form Has Been Published Successfully!</DialogTitle>
          <DialogDescription>
        ...
        <div className='flex flex-col'><p>Copy link</p>
          <div className='border-2 border-gray-200 flex justify-between items-center mt-2 pl-2 rounded-md'>
            ...
            <input
              className="w-full outline-none bg-transparent text-black" type="text"
              placeholder="link"
              disabled
